  ...
  const services = [
    {
      ...
      description: "Building dynamic websites and applications using PHP, Laravel, ReactJS, WordPress, and Shopify with responsive design."
    },
    {
      icon: Palette,
      title: "UI/UX Design",
      description: "Creating engaging and interactive web interfaces using HTML, CSS, and JavaScript for optimal user experience."
    },
    {
      icon: Database,
    ...
    },
    {
      ...
      description: "Implementing on-page and off-page SEO strategies to improve organic search rankings and drive traffic."
    }
  ];

  const experience = [
    {
      company: "Snapping Turtles Pvt. Ltd.",
    ...
    {
      company: "Digital Brand Crafters",
      role: "PHP Developer",
      period: "09/2023 - 04/2024",
      location: "Gurgaon"
    },
    {
      company: "Skillhollistic",
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {[
              {
                title: "Experienced",
                description: "2+ years working with leading companies on diverse projects"
              },
              {
              ...
              {
                title: "SEO Focused",
                description: "Every project optimized for search engines and performance"
              },
              {
                title: "Client-Oriented",
                description: "Strong focus on understanding and delivering client requirements"
              },
              {
                title: "Modern Tech",
                description: "Using latest technologies like React, Laravel, WordPress, Shopify"
              },
              {
                title: "Continuous Learning",
                description: "Committed to staying updated with new technologies and best practices"
              }
            ].map((item, index) => (
              <div
                key={item.title}
        ...
        <div className="max-w-7xl mx-auto">
          <div className="glass-card p-12 rounded-2xl bg-gradient-to-r from-primary/10 to-secondary/10 text-center animate-fade-in">
            ...
            <p className="text-muted-foreground mb-8 max-w-2xl mx-auto">
              Let's collaborate to create something amazing. Whether you need a new website, 
              web application, or SEO optimization, I'm here to help.
            </p>
