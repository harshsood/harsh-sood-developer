        ...
        <div className="max-w-7xl mx-auto">
          <div className="glass-card p-12 rounded-2xl bg-gradient-to-r from-primary/10 to-secondary/10 text-center animate-fade-in">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button size="lg" asChild className="glow-on-hover bg-gradient-primary"><Link to="/contact">Get In Touch</Link></Button>
              <Button variant="outline" size="lg" asChild className="glow-on-hover"><Link to="/projects">View My Work</Link></Button>
            </div>
          </div>
        </div>
      </section>
